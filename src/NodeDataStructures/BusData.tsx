class BusData {
	...
	public setOutputOrder(newOutputOrder: Array<string>) {
		// outputs are columns
		let newEnergyFlow: Array<Array<number>> = [];
	...
	public addToOutputOrder(nodeID: string) {
	...
	public removeFromInputOrder(nodeID: string) {
	...
	public removeFromOutputOrder(nodeID: string) {
