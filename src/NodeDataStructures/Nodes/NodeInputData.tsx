...
export function getNodeInputs(componentType: string, mediums: Medium[]): NodeInput[] {
	...
	const configs: Record<string, NodeInput[]> = {
		...
		gridinput: [
			...
			new NodeInput(NodeInputType.NUMBER, 'constant_temperature', 'Constant Temperature', -9999),
			new NodeInput(
		...
		boundedsupply: [
			new NodeInput(NodeInputType.MEDIUM, 'medium', 'Medium', 'FILL_IN'),
			new NodeInput(NodeInputType.NUMBER, 'constant_power', 'Constant Power', -9999),
			new NodeInput(NodeInputType.NUMBER, 'constant_temperature', 'Constant Temperature', -9999),
			new NodeInput(
				NodeInputType.STRING,
			...
			new NodeInput(NodeInputType.NUMBER, 'scale', 'Scale', -9999),
		],
		boundedsink: [
			new NodeInput(NodeInputType.MEDIUM, 'medium', 'Medium', 'FILL_IN'),
			new NodeInput(NodeInputType.NUMBER, 'constant_power', 'Constant Power', -9999),
		...
		fixedsupply: [
			new NodeInput(NodeInputType.MEDIUM, 'medium', 'Medium', 'FILL_IN'),
			new NodeInput(NodeInputType.NUMBER, 'constant_supply', 'Constant Supply', -9999),
			new NodeInput(NodeInputType.NUMBER, 'constant_temperature', 'Constant Temperature', -9999),
		...
		demand: [
			new NodeInput(NodeInputType.MEDIUM, 'medium', 'Medium', 'FILL_IN'),
			new NodeInput(NodeInputType.NUMBER, 'constant_demand', 'Constant Demand', -9999),
			new NodeInput(NodeInputType.NUMBER, 'constant_temperature', 'Constant Temperature', -9999),
			new NodeInput(NodeInputType.STRING, 'energy_profile_file_path', 'Energy Profile File Path', 'FILL_IN'),
			new NodeInput(
				NodeInputType.STRING,
		...
		storage: [
			new NodeInput(NodeInputType.MEDIUM, 'medium', 'Medium', 'FILL_IN'),
			new NodeInput(NodeInputType.NUMBER, 'capacity', 'Capacity', -9999),
			new NodeInput(NodeInputType.NUMBER, 'load', 'Load', -9999),
		],
		genericheatsource: [
			new NodeInput(NodeInputType.MEDIUM, 'medium', 'Medium', 'FILL_IN'),
			new NodeInput(NodeInputType.NUMBER, 'constant_power', 'Constant Power', -9999),
		...
		fuelboiler: [
			...
			new NodeInput(NodeInputType.NUMBER, 'power_th', 'Power Th', -9999),
			...
			new NodeInput(NodeInputType.NUMBER, 'min_power_fraction', 'Min Power Fraction', 0.1),
			new NodeInput(NodeInputType.NUMBER, 'output_temperature', 'Output Temperature', -9999),
		],
		heatpump: [
			new NodeInput(NodeInputType.NUMBER, 'power_th', 'Power Th', -9999),
			...
			new NodeInput(NodeInputType.MEDIUM, 'm_heat_out', 'M Heat Out', 'm_h_w_ht1'),
			new NodeInput(NodeInputType.NUMBER, 'input_temperature', 'Input Temperature', -9999),
			new NodeInput(NodeInputType.NUMBER, 'output_temperature', 'Output Temperature', -9999),
			new NodeInput(NodeInputType.STRING, 'cop_function', 'Cop Function', 'const:3.5'),
			new NodeInput(NodeInputType.NUMBER, 'bypass_cop', 'Bypass Cop', 15.0),
			...
			new NodeInput(NodeInputType.NUMBER, 'heat_losses_factor', 'Heat Losses Factor', 0.97),
			new NodeInput(NodeInputType.NUMBER, 'power_losses_factor', 'Power Losses Factor', 0.97),
			...
			new NodeInput(NodeInputType.NUMBER, 'optimal_plr', 'Optimal Plr', 0.5),
			new NodeInput(NodeInputType.NUMBER, 'nr_optimisation_passes', 'Nr Optimisation Passes', 10),
		],
		pvplant: [
			new NodeInput(NodeInputType.STRING, 'energy_profile_file_path', 'Energy Profile File Path', 'FILL_IN'),
			new NodeInput(NodeInputType.NUMBER, 'scale', 'Scale', -9999),
		...
		battery: [
			new NodeInput(NodeInputType.MEDIUM, 'medium', 'Medium', 'FILL_IN'),
			new NodeInput(NodeInputType.NUMBER, 'capacity', 'Capacity', -9999),
			new NodeInput(NodeInputType.NUMBER, 'initial_charge', 'Initial Charge', -9999),
		],
		electrolyser: [
			new NodeInput(NodeInputType.NUMBER, 'power_el', 'Power El', -9999),
			new NodeInput(NodeInputType.MEDIUM, 'm_el_in', 'M El In', 'm_e_ac_230v'),
			...
			new NodeInput(NodeInputType.NUMBER, 'output_temperature_ht', 'Output Temperature Ht', -9999),
			new NodeInput(NodeInputType.NUMBER, 'output_temperature_lt', 'Output Temperature Lt', -9999),
			new NodeInput(NodeInputType.NUMBER, 'nr_switchable_units', 'Nr Switchable Units', 2),
			new NodeInput(NodeInputType.STRING, 'dispatch_strategy', 'Dispatch Strategy', 'equal_with_mpf'),
			new NodeInput(NodeInputType.NUMBER, 'min_power_fraction', 'Min Power Fraction', 0.4),
			new NodeInput(NodeInputType.NUMBER, 'min_power_fraction_total', 'Min Power Fraction Total', 0.2),
			new NodeInput(NodeInputType.NUMBER, 'optimal_unit_plr', 'Optimal Unit Plr', 0.5),
		],
		buffertank: [
			new NodeInput(NodeInputType.MEDIUM, 'medium', 'Medium', 'm_h_w_ht1'),
			new NodeInput(NodeInputType.NUMBER, 'capacity', 'Capacity', -9999),
			new NodeInput(NodeInputType.NUMBER, 'volume', 'Volume', -9999),
			new NodeInput(NodeInputType.STRING, 'model_type', 'Model Type', 'ideally_stratified'),
			new NodeInput(NodeInputType.NUMBER, 'high_temperature', 'High Temperature', -9999),
			new NodeInput(NodeInputType.NUMBER, 'low_temperature', 'Low Temperature', -9999),
			new NodeInput(NodeInputType.NUMBER, 'rho_medium', 'Rho Medium', 1000),
			new NodeInput(NodeInputType.NUMBER, 'cp_medium', 'Cp Medium', 4.18),
			new NodeInput(NodeInputType.NUMBER, 'initial_load', 'Initial Load', 0.5),
			new NodeInput(NodeInputType.NUMBER, 'max_load_rate', 'Max Load Rate', 1.0),
			new NodeInput(NodeInputType.NUMBER, 'max_unload_rate', 'Max Unload Rate', 1.5),
			new NodeInput(NodeInputType.NUMBER, 'switch_point', 'Switch Point', 0.25),
			new NodeInput(NodeInputType.BOOLEAN, 'consider_losses', 'Consider Losses', true),
			new NodeInput(NodeInputType.NUMBER, 'h_to_r', 'H To R', 2),
			new NodeInput(NodeInputType.NUMBER, 'constant_ambient_temperature', 'Constant Ambient Temperature', 18),
			new NodeInput(NodeInputType.NUMBER, 'ground_temperature', 'Ground Temperature', 12),
			new NodeInput(NodeInputType.NUMBER, 'thermal_transmission_lid', 'Thermal Transmission Lid', 1.0),
			new NodeInput(NodeInputType.NUMBER, 'thermal_transmission_barrel', 'Thermal Transmission Barrel', 1.0),
			new NodeInput(NodeInputType.NUMBER, 'thermal_transmission_bottom', 'Thermal Transmission Bottom', 1.0),
		],
		chpp: [
